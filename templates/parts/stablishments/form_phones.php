<?php
    $establishment_phones = get_query_var('establishment_phones');
    $phones = isset($establishment_phones['values']) ? $establishment_phones['values'] : array();
    $ddi = $phones['ddi'] ?? '';
    $ddd = $phones['ddd'] ?? '';
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group">
                        <input
                            ...
                            name="user_phones_ddi_<?php echo esc_attr($establishment_phones['code']) ?>"
                            id="user_phones_ddi_<?php echo esc_attr($establishment_phones['code']) ?>"
                            aria-label="DDI"
                            maxlength="3"
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group">
                        <input
                            type="text"
                            class="form-control <?php echo esc_attr($itemRequireClass); ?>"
                            name="user_phones_ddd_<?php echo esc_attr($establishment_phones['code']) ?>"
                            id="user_phones_ddd_<?php echo esc_attr($establishment_phones['code']) ?>"
                            aria-label="DDD"
                            maxlength="3"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input
                            type="text"
                            class="form-control <?php echo esc_attr($itemRequireClass); ?>"
                            name="user_phones_number_<?php echo esc_attr($establishment_phones['code']) ?>"
                            id="user_phones_number_<?php echo esc_attr($establishment_phones['code']) ?>"
                            aria-label="Número"
                            maxlength="11"
