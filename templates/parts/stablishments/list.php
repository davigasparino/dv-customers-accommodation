    ...
    <div class="row mb-3">
        <div class="col-3">
            ...
            <div id="carouselList<?php echo esc_attr(get_the_ID()); ?>" class="carousel slide">
                <div class="carousel-indicators">
                    <?php $imgCount = 0; foreach ($images as $image_key => $image): ?>
                ...
                <div class="carousel-inner">
                    <?php $imgCount = 0; foreach ($images as $image): ?>
                        <div class="carousel-item <?php echo esc_attr(($imgCount === 0) ? 'active' : ''); ?>">
                            <img src="<?php echo wp_get_attachment_image_url($image['img'], 'medium') ?>" style="height: 120px; object-fit: cover;" class="d-block w-100 " alt="...">
                        </div>
                    <?php $imgCount++; endforeach;?>
                </div>
        ...
        <div class="col-6">
            <h3><?php echo esc_html($postDatas['name']); ?></h3>
            <p><?php echo esc_html(isset($postDatas, $postDatas['coust']) ? $postDatas['coust'] : ''); ?></p>
        </div>
        <div class="col-3">
